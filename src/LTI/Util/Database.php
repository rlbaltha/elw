...
$_SESSION['iss'] = [];
$reg_configs = array_diff(scandir(__DIR__ . '/../Config'), array('..', '.', '.DS_Store'));
foreach ($reg_configs as $key => $reg_config) {
    $_SESSION['iss'] = array_merge($_SESSION['iss'], json_decode(file_get_contents(__DIR__ . "/../Config/$reg_config"), true));
}
